 ...
 * @author uko
 */
public class RB<keyType extends Comparable<? super keyType>, dataType>
{
	private class Node<keyType extends Comparable<? super keyType>, dataType>
	{
		public keyType key;
		public dataType value;
		public Node<keyType, dataType> left;
		public Node<keyType, dataType> right;
		public Node<keyType, dataType> parent;
		public Color color;
		public Node(keyType key, dataType value, Color nodeColor, Node<keyType, dataType> left, Node<keyType, dataType> right)
		{
			this.key = key;
			this.value = value;
		...
		public Node<keyType, dataType> grandpa()
		{
			return parent.parent;
		}
		public Node<keyType, dataType> brother()
		{
			if (this == parent.left)
			{
				return parent.right;
		...
		public Node<keyType, dataType> uncle()
		{
	...
	private Node<keyType, dataType> lookupNode(keyType key)
	{
		Node<keyType, dataType> n = root;
		while (n != null)
		{
	...
	{
		Node<keyType, dataType> n = lookupNode(key);
		if (n == null)
			return null;
		return n.value;
	}
	private void rotateLeft(Node<keyType, dataType> n)
	{
		Node<keyType, dataType> r = n.right;
		replaceNode(n, r);
		n.right = r.left;
		if (r.left != null)
		{
	...
	private void rotateRight(Node<keyType, dataType> n)
	{
		Node<keyType, dataType> l = n.left;
		replaceNode(n, l);
		n.left = l.right;
		if (l.right != null)
		{
	...
	private void replaceNode(Node<keyType, dataType> oldn, Node<keyType, dataType> newn)
	{
		if (oldn.parent == null)
		{
			root = newn;
	 ...
	 * @param value
	 */
	public void insert(keyType key, dataType value)
	{
		Node<keyType, dataType> insertedNode = new Node<keyType, dataType>(key, value, Color.RED, null, null);
		if (root == null)
		{
			root = insertedNode;
		}
		...
		{
			Node<keyType, dataType> runner = root;
			while (true)
			{
	 ...
	 * @param n added node
	 */
	private void insertCase1(Node<keyType, dataType> n)
	{
		if (n.parent == null)
		{
			n.color = Color.BLACK;
	 ...
	 * @param n
	 */
	private void insertCase2(Node<keyType, dataType> n)
	{
	 ...
	 * @param n
	 */
	private void insertCase3(Node<keyType, dataType> n)
	{
	 ...
	 * @param n
	 */
	private void insertCase4(Node<keyType, dataType> n)
	{
	 ...
	 * @param n
	 */
	private void insertCase5(Node<keyType, dataType> n)
	{
		n.parent.color = Color.BLACK;
		n.grandpa().color = Color.RED;
	...
	public void delete(keyType key)
	{
		...
		{
			Node<keyType, dataType> pred = maximumNode(n.left);
			n.key = pred.key;
			n.value = pred.value;
			n = pred;
		}
	...
	private <K extends Comparable<? super K>, V> Node<K, V> maximumNode(Node<K, V> n)
	{
		while (n.right != null)
		{
			n = n.right;
	 ...
	 * @param n
	 */
	private void deleteCase1(Node<keyType, dataType> n)
	{
		if (n.parent == null)
		{
			return;
	 ...
	 * @param n
	 */
	private void deleteCase2(Node<keyType, dataType> n)
	{
	 ...
	 * @param n
	 */
	private void deleteCase3(Node<keyType, dataType> n)
	{
		if (nodeColor(n.parent) == Color.BLACK
	 ...
	 * @param n
	 */
	private void deleteCase4(Node<keyType, dataType> n)
	{
	 ...
	 * @param n
	 */
	private void deleteCase5(Node<keyType, dataType> n)
	{
		if (n == n.parent.left
				&& nodeColor(n.brother()) == Color.BLACK
	 ...
	 * @param n
	 */
	private void deleteCase6(Node<keyType, dataType> n)
	{
